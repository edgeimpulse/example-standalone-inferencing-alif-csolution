...
uint8_t ei_dsp_config_80_axes[] = { 0, 1, 2 };
const uint32_t ei_dsp_config_80_axes_size = 3;
ei_dsp_config_spectral_analysis_t ei_dsp_config_80 = {
    80, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 80
        80,
        39, // output size
        0, //&extract_spectral_analysis_features, // DSP function pointer
        (void*)&ei_dsp_config_80, // pointer to config struct
        ei_dsp_config_80_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_80_axes_size, // number of axes
        1, // version
...
const ei_config_tflite_eon_graph_t ei_config_tflite_graph_27 = {
    ...
    .model_init = 0,//&tflite_learn_27_init,
    .model_invoke = 0,//&tflite_learn_27_invoke,
    .model_reset = 0,//&tflite_learn_27_reset,
    .model_input = 0,//&tflite_learn_27_input,
    .model_output = 0,//&tflite_learn_27_output,
};
...
const ei_learning_block_config_anomaly_kmeans_t ei_learning_block_config_85 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_27_inputs[1] = { 80 };
const uint8_t ei_learning_block_27_inputs_size = 1;
const uint32_t ei_learning_block_85_inputs[1] = { 80 };
const uint8_t ei_learning_block_85_inputs_size = 1;
const ei_learning_block_t ei_learning_blocks[ei_learning_blocks_size] = {
    ...
    },
    {
        85,
        false,
        0,//&run_kmeans_anomaly,
        (void*)&ei_learning_block_config_85,
        EI_CLASSIFIER_IMAGE_SCALING_NONE,
        ei_learning_block_85_inputs,
        ei_learning_block_85_inputs_size,
        1
    },
};
...
const ei_impulse_t impulse_8669_0 = {
    .project_id = 8669,
...
ei_impulse_handle_t impulse_handle_8669_0 = ei_impulse_handle_t( &impulse_8669_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_8669_0;
